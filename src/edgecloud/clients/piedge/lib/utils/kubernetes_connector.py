...
from src.edgecloud.clients.piedge.lib.models import NodesResponse
...
# import traceback
import logging
from src.edgecloud.clients.piedge.lib.models.service_function_node_migration import ServiceFunctionNodeMigration
import json
...
class KubernetesConnector():
    def __init__(self, ip, port, token, username):
        ...
        # self.token_k8s=os.environ["KUBERNETES_MASTER_TOKEN"].strip()
    ...
    # Create an instance of the API class
            ...
            self.api_instance_apiregv1 = client.ApiregistrationV1beta1Api(api_client)
            self.api_instance_v1autoscale = client.AutoscalingV1Api(api_client)
            self.api_instance_v2beta1autoscale = client.AutoscalingV2beta1Api(api_client)
            self.api_instance_v2beta2autoscale = client.AutoscalingV2beta2Api(api_client)
            ...
            try:
                api_response = self.api_instance.get_api_group()

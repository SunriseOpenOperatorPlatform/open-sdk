...
from src.edgecloud.clients.piedge.lib.models.env_parameters import EnvParameters  # noqa: F401,E501
from src.edgecloud.clients.piedge.lib.models.volume_mount_deploy import VolumeMountDeploy  # noqa: F401,E501
...
class DeployServiceFunction(Model):
    ...
    """
    def __init__(self, service_function_name: str=None, service_function_instance_name: str=None, volume_mounts: List[VolumeMountDeploy]=None, autoscaling_metric: str=None, autoscaling_policy: str=None, count_min: int=None, count_max: int=None, location: str=None, all_node_ports: bool=None, monitoring_services: bool=None, node_ports: List[int]=None, env_parameters: List[EnvParameters]=None):  # noqa: E501

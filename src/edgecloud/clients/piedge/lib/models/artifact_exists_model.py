...
from src.edgecloud.clients.piedge.lib import util

class ArtifactExistsModel(Model):

    def __init__(self, registry_url : str=None, artefact_name: str=None, artefact_tag: str=None, username: str=None, password: str=None):

...
from sunrise6g_opensdk.edgecloud.clients.piedge.lib.models.app_manifest import AppManifest
from sunrise6g_opensdk.edgecloud.clients.piedge.lib.core.piedge_encoder import deploy_service_function
...
class EdgeApplicationManager(EdgeCloudManagementInterface):
    ...
    def __init__(self, base_url: str, **kwargs):
        ...
        self.edge_cloud_provider = kwargs['PLATFORM_PROVIDER']
        kubernetes_token = kwargs['KUBERNETES_MASTER_TOKEN']
